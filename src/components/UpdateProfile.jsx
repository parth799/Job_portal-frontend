...
import { clearAllUpdateProfileErrors, updateProfile } from "../stores/Slice/updateProfileSlice";
        ...
        <>
          ...
          <div>
            ...
            {user && user.resume && (
              <div>
                <p>Current Resume:</p>
                <Link to={user.resume && user.resume.url} target="_blank" className="view-resume">
                  View Resume
                </Link>
              </div>
            )}
